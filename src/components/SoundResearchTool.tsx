          ...
          {tags.map((tag) => (
            ...
            >
              ...
              <button
                ...
                className="text-purple-400/60 hover:text-red-400 ml-0.5"
              >
                ×
              </button>
            </span>
...
export function SoundResearchTool() {
  ...
  // Trouve le sousStack sélectionné et son entry
  let entree: SoundEntry | null = null;
  let sousStackCourant: { id: string; titre: string } | null = null;
  let stackCourant: { id: string; nom: string } | null = null;

  if (projet && sousStackSelectionne) {
    for (const s of projet.stacks) {
      const ss = s.sousStacks.find((ss) => ss.id === sousStackSelectionne);
      if (ss) {
        entree = ss.entry;
        sousStackCourant = { id: ss.id, titre: ss.titre };
        stackCourant = { id: s.id, nom: s.nom };
        break;
      }
    }
  }
  ...
  function handleSauvegarder(modifications: Partial<SoundEntry>) {
    ...
    modifierEntree(entreeSelectionnee, modifications);
  }
    ...
    <>
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-2xl mx-auto px-6 py-6">
          ...
          <div className="mb-6 flex items-start justify-between">
            <div className="flex-1 min-w-0">
              ...
              <h1 className="text-xl font-bold text-white truncate">
                {entree.titre_morceau || "Nouvelle recherche sonore"}
              </h1>
              {entree.artiste && (
                <p
          ...
          {/* ── Plugin — carte nom seul si pas dans pluginAssocie ── */}
